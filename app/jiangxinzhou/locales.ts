...
export const experienceCopy = {
  ...
  previousView: { zh: "上一视角", en: "Previous view" },
  islandHome: { zh: "返回全岛", en: "Island home" },
  information: { zh: "信息面板", en: "Information" },
  timeAndSky: { zh: "时间与天空", en: "Time & sky" },
  controlsHelp: { zh: "操作帮助", en: "Controls" },
  cameraGuided: { zh: "正在前往目标", en: "Flying to target" },
  cameraManual: { zh: "自由浏览", en: "Free camera" },
  detailedModelLoading: { zh: "精细模型载入中", en: "Loading detailed model" },
  layerPreset: { zh: "图层预设", en: "Layer presets" },
  layerPresetClean: { zh: "清爽", en: "Clean" },
  layerPresetTransport: { zh: "交通", en: "Transit" },
  layerPresetNature: { zh: "生态", en: "Nature" },
  renderingQuality: { zh: "渲染画质", en: "Rendering quality" },
  helpRotate: { zh: "单指或鼠标拖拽旋转", en: "Drag to orbit" },
  helpZoom: { zh: "双指或滚轮缩放，双指平移", en: "Pinch or scroll to zoom; two fingers to pan" },
  helpSelect: { zh: "点击地标、桥梁或站点聚焦；任何手势都能接管镜头", en: "Select a landmark, bridge or stop; any gesture takes over the camera" },
  expandDetails: { zh: "展开详情", en: "Expand details" },
  collapseDetails: { zh: "收起详情", en: "Collapse details" },
  selectedTarget: { zh: "当前目标", en: "Current target" },
  ...
  transportRealtime: { zh: "交通状态", en: "Transit status" },
  transportSimulated: { zh: "模拟实时", en: "Simulated live" },
  transportLive: { zh: "实时数据", en: "Live data" },
  transportDataStale: { zh: "数据延迟", en: "Stale data" },
  transportUpdated: { zh: "更新于", en: "Updated" },
  transportRefresh: { zh: "刷新交通状态", en: "Refresh transit status" },
  transportNextArrivals: { zh: "预计到站", en: "Next arrivals" },
  transportVehicles: { zh: "辆运行中", en: "vehicles" },
  transportNoArrivals: { zh: "当前暂无预计到站信息", en: "No arrival prediction available" },
  transportNotRunning: { zh: "当前不在运营时段", en: "Outside service hours" },
  transportVehicle: { zh: "3D 交通工具", en: "3D vehicle" },
  transportVehicleScale: { zh: "导览可视比例", en: "Guide-map display scale" },
  transportGeometryVerified: { zh: "道路中心线", en: "Road centerline" },
  transportGeometryDerived: { zh: "道路网络推导", en: "Road-network derived" },
  transportGeometryPartial: { zh: "部分道路推导", en: "Partly road-derived" },
  transportGeometrySchematic: { zh: "站序示意线", en: "Schematic stop line" },
  transportMeasuredLength: { zh: "模型线长", en: "Model length" },
  transportOfficialLength: { zh: "官方长度", en: "Official length" },
  ...
  ferryPublishedReference: { zh: "公开班次参考", en: "Published schedule reference" },
  ferrySimulatedNotice: { zh: "模拟班次 · 以当日公告为准", en: "Simulated · same-day notices prevail" },
  ferryRunning: { zh: "正在航行", en: "Crossing now" },
  ferryMoored: { zh: "停靠渡口", en: "Moored at pier" },
  ferrySuspended: { zh: "临时停航", en: "Temporarily suspended" },
  ferryEvidenceConflict: { zh: "路线长度存在资料口径差异", en: "Route length sources conflict" },
  ferryPierEvidence: { zh: "渡口照片核验模型", en: "Photo-checked pier model" },
