...
import { resolveGameTarget, landmarkPosition } from "./worldCatalog.ts";
...
export function createGameGateway(mode: GameMode, roomId?: string): GameGateway {
  ...
  return createLocalGameGateway({ mode, roomId, resolveTarget: resolveGameTarget, resolveLandmark: landmarkPosition });
}
